...
var AutoTranslate = function AutoTranslate(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading || translated ? children : t(keyPrefix + tKey, children), loading && loadingElement);
};
